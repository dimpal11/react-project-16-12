    ...
    <nav className="bg-[#ECF4F1] border-b border-[#C4EDD7] z-10 ">
      <div className=" mx-auto flex items-center justify-between p-2  md:px-8">
        ...
        <div className="hidden md:flex space-x-6 items-center">
          <a href="#" className="hover:text-[#43916F]  text-xs font-bold uppercase">Home</a>
          <a href="#" className="hover:text-[#43916F]   text-xs font-bold uppercase">Features</a>
          <a href="#" className="hover:text-[#43916F]   text-xs font-bold uppercase">About Us</a>
          {/* <a href="#" className="hover:text-gray-300">Contact</a> */}
          <button className="bg-[#105F62] text-white  py-2 px-4 rounded-sm  text-xs font-bold uppercase">Contact Us</button>
        </div>
      </div>
      ...
      >
        ...
        <nav className="mt-16 space-y-4">
          <a href="#" className="block px-4 py-2 hover:bg-gray-700 text-[#072B2C]">Home</a>
          <a href="#" className="block px-4 py-2 hover:bg-gray-700 text-[#072B2C]">About</a>
          <a href="#" className="block px-4 py-2 hover:bg-gray-700 text-[#072B2C]">Services</a>
          <a href="#" className="block px-4 py-2 hover:bg-gray-700 text-[#072B2C]">Contact</a>
          <button className="w-[50%] m-[5%] bg-[#105F62] text-white hover:bg-[#105F62] px-4 py-2 mt-2">Contact Us</button>
        </nav>
      </div>
    </nav>
    </div>
